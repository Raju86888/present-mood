...
# c:/users/rajus/pycharmprojects/pythonproject/venv/lib/site-packages
def startVideoCapture():
    ...
    print("resize time" + str(start - timer()))
    # c:/users/rajus/pycharmprojects/pythonproject/
    ...
    if flag1 is None:
        ...
        print("paint time 1" + str(start - timer()))
        paintDetectedEmotion()
        print("paint time" + str(start - timer()))
        lmain.after(750, startVideoCapture)
    if cv2.waitKey(1) & 0xFF == ord('q'):
        exit()


def paintDetectedEmotion():
